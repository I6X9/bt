...
#define CONFIG_MEMPOOL_SIZE                         (42 * 1024)
#else 
#define CONFIG_MEMPOOL_SIZE                         (42 * 1024)
#endif
...
//    #define SUPPORT_SPP_IN_MP3PLAYER            1 // allow spp conn in mp3player/linein mode
    ...
    //#define CONFIG_LINE_SD_SNIFF    //全功能版本LINEIN/SD
#ifdef CONFIG_APP_USB     // U盘模式时，不支持SNIFF功能
    #undef CONFIG_APP_USB
#endif
#endif
...
/********* 该宏为收费EQ: 立体声为7软+3硬 / 单声道为10软 ************/
#define USER_EX_EQ		0			//外部EQ算法开启宏
...
//以下为AMA/BAIDU/TIANMAO双模配置注意事项

#ifdef BT_DUALMODE

#define AMA_ENABLE      			0		// 0: BAIDU/TIANMAO  /  1: AMA

#if (AMA_ENABLE == 1)
#define USER_BLE_ALWAYS_ENABLE		1		// AMA need alwyas enable ble
#endif

#if (AMA_ENABLE == 0)
//#define TIANMAO_ENABLE					// define is TIANMAO / not define is BAIDU

#ifdef TIANMAO_ENABLE
#define USER_BLE_ALWAYS_ENABLE		0		// TIANMAO notneed alwyas enable ble
#else
#define USER_BLE_ALWAYS_ENABLE		1		// BAIDU need alwyas enable ble
#endif
...
#define CONFIG_XIAONIU_DEVICE_TEST 	  1		// 1为打开 小牛测试仪器串口通信功能
