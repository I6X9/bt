...
RAM_CODE void BK3000_Ana_Decrease_Current(u_int8 enable)
{
	if(enable)
	{
		GPIO_Ax.a7->Audiocssw = 1;
		//GPIO_Ax.a7->daccssw1V = 0;
		//GPIO_Ax.a7->adccssel  = 0;
	}
	else
	{
		GPIO_Ax.a7->Audiocssw = 0;
		//GPIO_Ax.a7->daccssw1V = 1;
		//GPIO_Ax.a7->adccssel  = 1;
	}
}
...
void BK3000_Ana_Line_enable( uint8 enable )
{
    ...
    #endif
        BK3000_A6_CONFIG |= (1<<28);  //  micrefbuf_en<28>=1
