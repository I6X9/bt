...
#define BK3000_GPIO_GPIOCON1                  (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+32*4)))
#define BK3000_GPIO_GPIOCON2                  (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+59*4)))
#define BK3000_GPIO_GPIOCON3                  (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+38*4)))
#define BK3000_GPIO_GPIOCON4                  (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+31*4)))
...
#define BK3000_GPIO_CLKOUT_SET                 (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+46*4)))
...
#define is_USB_Plug_in()                            (BK3000_GPIO_DRB & (1<<1))
...
#define BK3000_IRDA_CAP_CTRL       (*((volatile unsigned int *)   (BK3000_IRDA_BASE_ADDR+4*4)))
#define BK3000_IRDA_CAP_DATA       (*((volatile unsigned int *)   (BK3000_IRDA_BASE_ADDR+5*4)))

#define sft_IRDA_INT_MODE                6
#define IRDA_INT_MODE_IRDA 0
#define IRDA_INT_MODE_CAP 1

#define IRDA_CAP_INT_CLR                (1<<5)

#define sft_IRDA_CAP_DIV                    2
#define IRDA_CAP_DIV_2 1
#define IRDA_CAP_DIV_4 2
#define IRDA_CAP_DIV_8 3
#define IRDA_CAP_DIV_16 4
#define IRDA_CAP_DIV_32 5

#define    sft_IRDA_CAP_EDGE                    0
enum
{
    IRDA_MODE_EDGE_DUAL,
	IRDA_MODE_EDGE_POS,
