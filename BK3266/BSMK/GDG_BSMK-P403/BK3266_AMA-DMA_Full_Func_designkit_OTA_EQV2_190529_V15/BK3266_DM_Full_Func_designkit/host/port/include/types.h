...
typedef unsigned char           u8;  /* unsigned integer,  8 bits long */
typedef unsigned short          u16; /* unsigned integer, 16 bits long */
typedef unsigned int            u32; /* unsigned integer, 32 bits long */
