#include "config.h"
#if(AMA_ENABLE==1)
#ifndef _DUEROS_AMA_H_
#define _DUEROS_AMA_H_
...
typedef struct dueros_dma_operation{
	...
	//void (*get_pair_config)(PairInformation*);
	void (*get_central_info)(GetCentralInformation*);
...
//	DUEROS_DMA_USR_REG_OPER dma_user_oper;
	DUEROS_QUEQUE audio_data_queque;
	DUEROS_QUEQUE cmd_data_queque;
}DUEROS_DMA;


int dueros_dma_init(PROTOCOL_VER*dma_version,DUEROS_DMA_OPER *dma_oper);
