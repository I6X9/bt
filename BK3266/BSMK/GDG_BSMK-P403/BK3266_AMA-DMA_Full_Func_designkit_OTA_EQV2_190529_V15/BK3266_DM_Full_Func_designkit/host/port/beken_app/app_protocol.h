...
extern 	app_rgb_info_t rgb_info;
...
#define 	RGB_R_PIN       		GPIO8
#define 	RGB_G_PIN		        GPIO9
#define 	RGB_B_PIN		        GPIO10
...
#define APP_WAVE_FILE_ID_AILI_SCO_START		APP_WAVE_FILE_ID_RESERVED9
...
void Aili_Voice_Key_Short(void);
void Aili_Voice_Key_Hold(void);
void Aili_Voice_Key_Hold_Up(void);
void api_loop();
