...
//#define SBC_FIRST_DISCARD_ENABLE    0    //discard overflow data avoid "pop"
    ...
    #define SBC_FIRST_DISCARD_ENABLE    1    //discard overflow data avoid "pop"
            ...
            #define SBC_ENCODE_BUFFER_LEN       12288
            #define SBC_MEM_POOL_MAX_NODE       102
        #else
            //#define SBC_FIRST_TRY_TIME         50	// 15		//55    // 2
            //#define SBC_ENCODE_BUFFER_LEN      8192 //4096		//8192  //4096
            //#define SBC_MEM_POOL_MAX_NODE      68	//34		//70    //34
        ...
        #ifdef BT_DUALMODE
            #define SBC_FIRST_TRY_TIME          5
            #define SBC_ENCODE_BUFFER_LEN       4096 /*DualMode use only*/
            #define SBC_MEM_POOL_MAX_NODE       34
        #elif 1
