...
//    BEKEN_DISABLE_ESCO                          =0x3A,    
	...
	BEKEN_CMD_MACADDR_READ						=0x62,		//MAC ADDR READ
	BEKEN_CMD_MACADDR_UPDATE					=0x6A,		//MAC ADDR SET
	BEKEN_ENTRY_BATT_VLCF_READ					=0x71,		//BATT READ
	BEKEN_ENTRY_BATT_VLCF_UPDATE				=0x75,		//BATT UPDATE
	BEKEN_CMD_CRC_READ							=0x7A,		//CRC READ
	BEKEN_CMD_OS_PRINTF_ENABLE					=0x7F,		//OS PRINTF ENABLE
