...
static u_int32 GAP_Adv_Interval_Min = 160;//800;//128;//160;//480;//32;   /*160=100ms;320=200ms;480=300ms,640=400ms;800=500ms*/
static u_int32 GAP_Adv_Interval_Max = 160;//800;//;//160;//32;
