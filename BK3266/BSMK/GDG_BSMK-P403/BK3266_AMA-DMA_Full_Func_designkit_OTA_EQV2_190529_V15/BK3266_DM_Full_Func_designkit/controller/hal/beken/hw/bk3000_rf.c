...
void BK3000_RF_Initial(uint8 dut_mode) 
{    /**< Thu Nov 13 11:42:33 2014 */
    ...
    if(dut_mode)
    {
        ...
        BK3000_XVR_REG_0x24 = XVR_reg_0x24_save      = 0x00141802;// 0x000005A9; for +PA 0x0129
        ...
        BK3000_XVR_REG_0x02 =XVR_analog_reg_save[2]  = 0x2A924005;
        //BK3000_XVR_REG_0x02 =XVR_analog_reg_save[2]  = 0x0B32E24A; //0x2A924005;
        ...
        BK3000_XVR_REG_0x0B =XVR_analog_reg_save[11] = 0x80F4678F;//0x80F4E78F;//0x80F4EFFF;
        BK3000_XVR_REG_0x0C =XVR_analog_reg_save[12] = 0x00060339;//0x01060273;
        BK3000_XVR_REG_0x0D =XVR_analog_reg_save[13] = 0x8101011F;
        ...
        BK3000_XVR_REG_0x2D							 = 0x002D4846;
                                                             
        // TX Modulate                                                 
        BK3000_XVR_REG_0x30                          = 0xA432981B;// 0xA832941B;//0xA828A41C;//0x00011010;// 0x00011010;0xA828941C
        //BK3000_XVR_REG_0x30                          = 0x00011110; //0xA432981B;// 0xA832941B;//0xA828A41C;//0x00011010;// 0x00011010;0xA828941C
        ...
        BK3000_XVR_REG_0x3C                          = 0xB08403D1;//0x308403D1;//0x1E8403B1;// 0x108403B1;
    ...
    else
    {
        ...
        BK3000_XVR_REG_0x23                          = 0x7B13B14B;// 0x2E276276;
        BK3000_XVR_REG_0x24 = XVR_reg_0x24_save      = 0x00141802;// 0x000005A9; for +PA 0x0129 0x00140C02
        BK3000_XVR_REG_0x27                          = 0x0008F100;// 0x000A0000;
        ...
        BK3000_XVR_REG_0x09 =XVR_analog_reg_save[9]  = 0x23DFF300;//0x2BDFF304;
        BK3000_XVR_REG_0x0A =XVR_analog_reg_save[10] = 0x42805FD7;//0x44805FD7;//0x42805FD7;//0x42805FD7;
        BK3000_XVR_REG_0x0B =XVR_analog_reg_save[11] = 0x80F46F8F;//0x80F4E78F;//0x80F4EFFF;
        BK3000_XVR_REG_0x0C =XVR_analog_reg_save[12] = 0x20060339;//0x01060273;
    ...
    BK3000_XVR_REG_0x27                         = 0x000004020;
        ...
        BK3000_XVR_REG_0x29                          = 0x0D041100;// 0x00001100;
    #ifdef BT_DUALMODE
        BK3000_XVR_REG_0x2A                          = 0x01504032;// 0x01504042;
    #else
        BK3000_XVR_REG_0x2A                          = 0x01504042;// 0x01504042;
    #endif
        ...
        BK3000_XVR_REG_0x3A                          = 0x00000000;// 0x00000000;
    #ifdef BT_DUALMODE
        BK3000_XVR_REG_0x3B                          = 0x51345288;// 0x09345288;49345288
    #else
        BK3000_XVR_REG_0x3B                          = 0x49345288;// 0x09345288;49345288
    #endif
...
#if 1
    uint32 xvr_reg;
    BK3000_XVR_REG_0x24                          = 0x00141808;
